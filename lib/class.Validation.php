...
class Validation
{
         ...
         * 戻値：        ：正規の値ならば真を、問題があれば偽を返す
         ****************************************************************************/
        function isDW_ISBN($value = "", $require = false, $max = 14, $min = 0, $enc_chk = "UTF-8", $enc_sou = "UTF-8"){
                $ret = true;
         ...
         * 戻値：        ：正規の値ならば真を、問題があれば偽を返す
         ****************************************************************************/
        function isDW_ASIN($value = "", $require = false, $max = 14, $min = 0, $enc_chk = "UTF-8", $enc_sou = "UTF-8"){
                $ret = true;
